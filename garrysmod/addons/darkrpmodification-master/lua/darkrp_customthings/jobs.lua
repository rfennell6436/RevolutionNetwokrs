...
TEAM_41STCMD = DarkRP.createJob("41st Commander Gree", {
    ...
    description = [[You're are a Clone of the Galactic Republic. Use your equipped weapons to fight through the CIS and take the Republic to victory!]],
    weapons = {"rw_sw_dc15a_o", "rw_sw_dc15s", "rw_sw_dual_dc17", "rw_sw_dc15x"},
    command = "41stcmd",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_41STOFF = DarkRP.createJob("41st Officer", {
    ...
    description = [[You're are a Clone of the Galactic Republic. Use your equipped weapons to fight through the CIS and take the Republic to victory!]],
    weapons = {"rw_sw_dc15a_o", "rw_sw_dc15s", "rw_sw_dc17", "rw_sw_dc15x"},
    command = "41stoff",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_41STMED = DarkRP.createJob("41st Medical Trooper", {
    ...
    description = [[You're are a Clone of the Galactic Republic. Use your equipped weapons to fight through the CIS and take the Republic to victory!]],
    weapons = {"rw_sw_dc15a_o", "rw_sw_dc15s", "rw_sw_dc17", "weapon_bactainjector", "rw_sw_nade_bacta", "rw_sw_dc15x"},
    command = "41stmed",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_41STHVY = DarkRP.createJob("41st Heavy Trooper", {
    ...
    description = [[You're are a Clone of the Galactic Republic. Use your equipped weapons to fight through the CIS and take the Republic to victory!]],
    weapons = {"rw_sw_dc15a_o", "rw_sw_dc15s", "rw_sw_dc17", "rw_sw_z6", "alydus_fortificationbuildertablet", "rw_sw_dc15x"},
    command = "41sthvy",
    max = 0,
    salary = 100,
    admin = 0,
...
TEAM_41STARC = DarkRP.createJob("41st ARC Trooper", {
    ...
    description = [[You're are a Clone of the Galactic Republic. Use your equipped weapons to fight through the CIS and take the Republic to victory!]],
    weapons = {"rw_sw_dc15a_o", "rw_sw_dc15s", "rw_sw_dc17", "rw_sw_westarm5", "rw_sw_dc15x"},
    command = "41starc",
    max = 0,
    salary = 100,
    admin = 0,
